change idea formater for A+S+L<#-- layout -->
<#macro layout>
    <!DOCTYPE html>
    ...
    <head>
        ...
        <link rel="apple-touch-icon-precomposed"
              href="http://mtons.com/dist/images/logo.png"/>
        ...
        <link href="${base}/dist/vendors/bootstrap/css/bootstrap.min.css"
              rel="stylesheet">
        <!-- Font Awesome -->
        <link href="${base}/dist/vendors/font-awesome/css/font-awesome.min.css"
              rel="stylesheet">

        <!-- Theme Style -->
        <link href="${base}/theme/admin/dist/css/site.css" rel="stylesheet">
        <link href="${base}/theme/admin/dist/css/site.addons.css"
              rel="stylesheet">
        <link href="${base}/theme/admin/dist/css/skins/skin-blue.css"
              rel="stylesheet">
    ...
    <div class="wrapper">
            ...
            <nav class="navbar navbar-static-top">
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        <li><a href="/" title="跳转到前台" target="_blank"><i
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle"
                               data-toggle="dropdown">
                                <img src="<@resource src=profile.avatar/>"
        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li>
                        <a href="${base}/admin" class="active"><i
                                    class="fa fa-dashboard"></i><span>仪表盘</span></a>
                    </li>
                    <@menus>
                        <#list results as menu>
                            <li><a href="${base}/${menu.url}"><i
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2019 <a href="#">mtons</a>.</strong> All
            rights reserved.
        </footer>
    </body>
    </html>
...
<#macro pager url p spans>
    ...
    <ul class="pagination no-margin pull-right">
        <#if (pageNo > 1)>
            <#local prev = pageNo - 1 />
            <li><a class="prev" href="${cURL}${prev}" pageNo="1">&nbsp;<i
        ...
        <#if (pageNo lt p.totalPages)>
            <#local next = pageNo + 1/>
            <li><a href="${cURL}${next}" pageNo="${next}">&nbsp;<i
...
<#macro pagelink pageNo idx url>
    ...
    <#elseif (pageNo == idx)>
        <li class="active"><a
                    href="javascript:void(0);"><span>${idx}</span></a></li>
    <#else>
