...
;!function (a, b) {
    ...
    a.layer = {
        ...
        use: function (a, b, d) {
            var e = c("head")[0], a = a.replace(/\s/g, ""),
                f = /\.css$/.test(a),
        ...
        msg: function (a, d, f) {
            var h = "function" == typeof d, i = e.config.skin,
    ...
    g.anim = ["layui-anim", "layui-anim-01", "layui-anim-02", "layui-anim-03", "layui-anim-04", "layui-anim-05", "layui-anim-06"], f.pt.config = {
        ...
        var c = this, d = c.index, f = c.config, h = f.zIndex + d,
        ...
        var a = this, b = a.config, f = a.index, h = b.content,
            i = "object" == typeof h;
        ...
        var a = this, b = a.config, c = a.layero,
        ...
        var a = this, b = a.config, e = a.layero,
            f = [e.outerWidth(), e.outerHeight()], h = c(b.follow);
        h[0] || (h = c("body"));
        var i = {
            width: h.outerWidth(),
        ...
        var a = this, b = a.config, e = {
            setY: 0, moveLayer: function () {
                var a = e.layero, b = parseInt(a.css("margin-left")),
        ...
        return b.move && f.attr("move", "ok"), f.css({cursor: b.move ? "move" : "auto"}), c(b.move).on("mousedown", function (a) {
            if (a.preventDefault(), "ok" === c(this).attr("move")) {
                ...
                var f = e.layero.offset().left, h = e.layero.offset().top,
        ...
        if (a) {
            var b = layer.getChildFrame("body", a).outerHeight(),
                d = c("#" + g[0] + a), e = d.find(g[1]).outerHeight() || 0,
