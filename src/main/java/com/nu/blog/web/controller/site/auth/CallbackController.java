package com.nu.blog.web.controller.site.auth;

import com.nu.blog.base.lang.Consts;
import com.nu.blog.base.lang.BlogException;
import com.nu.blog.base.lang.Result;
import com.nu.blog.base.oauth.*;
import com.nu.blog.base.oauth.utils.OpenOauthBean;
import com.nu.blog.base.oauth.utils.TokenUtil;
import com.nu.blog.base.utils.FilePathUtils;
...
import com.nu.blog.modules.service.OpenOauthService;
...
public class CallbackController extends BaseController {
     ...
     * @param request
     * @param response
     * @author A蛋壳  2021年9月12日 下午3:05:54
     */
    ...
    public String callback4Weibo(String code, String state, HttpServletRequest request, ModelMap model) throws Exception {
        ...
        if (StringUtils.isBlank(state) || StringUtils.isBlank(session_state) || !state.equals(session_state) || StringUtils.isBlank(code)) {
            throw new BlogException("缺少必要的参数");
        }
        ...
        try {
            ...
            throw new BlogException("解析信息时发生错误");
        }
     ...
     * @param request
     * @param response
     * @author A蛋壳  2021年9月12日 下午3:28:21
     */
    ...
    public void callQQ(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            throw new BlogException("跳转到QQ授权接口时发生异常");
        }
    }
     ...
     * @param request
     * @param response
     * @author A蛋壳  2021年9月12日 下午3:09:39
     */
    ...
    public void callDouban(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            throw new BlogException("跳转到豆瓣授权接口时发生异常");
        }
    }
     ...
     * @param request
     * @param model
     * @author A蛋壳  2021年9月12日 下午5:32:51
     */
